...
## Авто обновление данных при изменении ConfigMap
...
Если дынные были смонтированы отдельными файлами с использованием `subPath` или переданы как переменные окружения, то для обновления данных придется перезапускать контейнеры.